...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Load Speed & Image Priority Boundary >> 21. Load Speed: All carousel images are using valid paths
- Location: tests\tier2_boundary_edge.spec.ts:259:7
