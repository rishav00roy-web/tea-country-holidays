...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Cookie Consent Banner (Conditional) >> 25. Cookie Consent: Check for cookie banner container element (skipped if missing)
- Location: tests\tier1_feature_coverage.spec.ts:188:7
