...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Auth Input Lengths & Stressing UI >> 9. Auth: Rapid toggling between Sign In and Sign Up modes
- Location: tests\tier2_boundary_edge.spec.ts:109:7
