...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Supabase SSR Auth - Form Boundary & Input Validation >> 2. Auth: Submit Sign Up with invalid email format and check HTML5 validation
- Location: tests\tier2_boundary_edge.spec.ts:26:7
