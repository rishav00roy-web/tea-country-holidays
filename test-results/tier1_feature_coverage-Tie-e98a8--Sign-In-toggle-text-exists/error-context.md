...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 10. Auth: Switch to Sign In toggle text exists
- Location: tests\tier1_feature_coverage.spec.ts:66:7
