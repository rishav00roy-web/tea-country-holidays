...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Cookie Consent Banner (Conditional) >> 27. Cookie Consent: Check for cookie banner decline button (skipped if missing)
- Location: tests\tier1_feature_coverage.spec.ts:211:7
