...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Password Recovery (Conditional) >> 30. Password Recovery: Check for reset password form submit button (skipped if missing)
- Location: tests\tier1_feature_coverage.spec.ts:247:7
