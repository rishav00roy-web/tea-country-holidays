...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Load Speed & Image Priority >> 23. Load Speed: Check that logo image exists on home page
- Location: tests\tier1_feature_coverage.spec.ts:174:7
