...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 9. Auth: Google OAuth button exists
- Location: tests\tier1_feature_coverage.spec.ts:59:7
