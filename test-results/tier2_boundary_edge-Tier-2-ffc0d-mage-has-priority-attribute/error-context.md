...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Load Speed & Image Priority Boundary >> 22. Load Speed: Inspect first slider image has priority attribute
- Location: tests\tier2_boundary_edge.spec.ts:271:7
