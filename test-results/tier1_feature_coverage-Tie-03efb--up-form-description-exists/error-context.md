...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 4. Auth: Sign up form description exists
- Location: tests\tier1_feature_coverage.spec.ts:27:7
