...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 11. Auth: Toggling to Sign In hides Full Name input
- Location: tests\tier1_feature_coverage.spec.ts:73:7
