...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Supabase SSR Auth - Form Boundary & Input Validation >> 3. Auth: Submit Sign Up with spaces in email (trimmed/allowed by input but handles gracefully)
- Location: tests\tier2_boundary_edge.spec.ts:40:7
