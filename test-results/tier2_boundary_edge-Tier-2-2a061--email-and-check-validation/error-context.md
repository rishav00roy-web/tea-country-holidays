...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Supabase SSR Auth - Form Boundary & Input Validation >> 4. Auth: Submit Sign In with empty email and check validation
- Location: tests\tier2_boundary_edge.spec.ts:48:7
