...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Cookie Consent Banner Boundary (Conditional) >> 26. Cookie Consent: Verify banner layout doesn't break page container width (skipped if missing)
- Location: tests\tier2_boundary_edge.spec.ts:315:7
