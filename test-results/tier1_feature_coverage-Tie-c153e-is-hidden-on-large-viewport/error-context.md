...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Mobile Responsiveness & Layout >> 17. Desktop: Hamburger button is hidden on large viewport
- Location: tests\tier1_feature_coverage.spec.ts:124:7
