...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 8. Auth: Sign Up submit button exists
- Location: tests\tier1_feature_coverage.spec.ts:52:7
