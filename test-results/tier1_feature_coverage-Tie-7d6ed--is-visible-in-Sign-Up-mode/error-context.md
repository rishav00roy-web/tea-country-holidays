...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 5. Auth: Full Name input is visible in Sign Up mode
- Location: tests\tier1_feature_coverage.spec.ts:34:7
