...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Auth Input Lengths & Stressing UI >> 7. Auth: Input extremely long email in Sign Up
- Location: tests\tier2_boundary_edge.spec.ts:91:7
