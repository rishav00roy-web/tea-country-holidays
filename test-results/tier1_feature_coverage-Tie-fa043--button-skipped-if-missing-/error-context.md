...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Cookie Consent Banner (Conditional) >> 26. Cookie Consent: Check for cookie banner accept button (skipped if missing)
- Location: tests\tier1_feature_coverage.spec.ts:199:7
