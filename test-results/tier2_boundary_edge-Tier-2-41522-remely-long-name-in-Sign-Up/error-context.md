...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Auth Input Lengths & Stressing UI >> 6. Auth: Input extremely long name in Sign Up
- Location: tests\tier2_boundary_edge.spec.ts:82:7
