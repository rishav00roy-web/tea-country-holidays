...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 1. Login page has correct title pattern
- Location: tests\tier1_feature_coverage.spec.ts:8:7
