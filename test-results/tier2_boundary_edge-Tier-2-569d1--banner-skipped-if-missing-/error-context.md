...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Cookie Consent Banner Boundary (Conditional) >> 25. Cookie Consent: Rapidly accept/decline banner (skipped if missing)
- Location: tests\tier2_boundary_edge.spec.ts:302:7
