...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 13. Auth: Toggling back to Sign Up shows Full Name input again
- Location: tests\tier1_feature_coverage.spec.ts:89:7
