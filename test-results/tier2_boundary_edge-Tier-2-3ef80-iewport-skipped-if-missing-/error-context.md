...
- Name: tier2_boundary_edge.spec.ts >> Tier 2: Cookie Consent Banner Boundary (Conditional) >> 24. Cookie Consent: Check banner at 320px viewport (skipped if missing)
- Location: tests\tier2_boundary_edge.spec.ts:290:7
