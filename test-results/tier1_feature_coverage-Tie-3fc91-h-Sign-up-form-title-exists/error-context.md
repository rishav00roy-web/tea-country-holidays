...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 3. Auth: Sign up form title exists
- Location: tests\tier1_feature_coverage.spec.ts:20:7
