...
- Name: tier1_feature_coverage.spec.ts >> Tier 1: Supabase SSR Auth - Sign Up / Sign In UI >> 7. Auth: Password input is visible in Sign Up mode
- Location: tests\tier1_feature_coverage.spec.ts:46:7
