...
export const metadata: Metadata = {
  ...
  description: "Plan bespoke weddings, corporate retreats, and private celebrations in premium locations like heritage tea estate bungalows and luxury resorts.",
