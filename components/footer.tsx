            ...
            <ul className="space-y-4 text-sm text-white/75">
              ...
              <li className="flex items-start gap-3 mt-1">
                ...
                <div className="flex flex-col gap-1">
                  <a href={`tel:+${phone}`} className="hover:text-brand-gold transition-colors">{phone.startsWith("91") && phone.length === 12 ? `+91 ${phone.substring(2, 7)} ${phone.substring(7)}` : phone}</a>
                </div>
              </li>
