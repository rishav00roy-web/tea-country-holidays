...
export default function Footer({
  ...
  return (
    <footer id="footer" className="bg-brand-evergreen text-white pt-20 pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-8 border-t-[3px] border-brand-gold/30 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            {/* Social links */}
            <ul className="example-2 flex-wrap gap-2 max-w-full">
              {[
            ...
            <ul className="space-y-4 text-sm text-white/75">
              ...
              <li className="flex items-start gap-3 mt-1">
                ...
                <div className="flex flex-col gap-1">
                  <a href={`tel:+${phone}`} className="hover:text-brand-gold transition-colors py-2 inline-block">{phone.startsWith("91") && phone.length === 12 ? `+91 ${phone.substring(2, 7)} ${phone.substring(7)}` : phone}</a>
                </div>
              </li>
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@teacountryholidays.com" className="hover:text-brand-gold transition-colors break-all py-2 inline-block">
