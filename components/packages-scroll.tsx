...
const packages = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1686472886489-1d2d7e08ff9c?w=400&q=80",
  },
  {
    name: "Bhutan Royal Tour",
    duration: "7N/8D",
    destination: "Bhutan",
    imageUrl: "https://images.unsplash.com/photo-1578556881786-851d4b79cb73?w=400&q=80",
  },
  {
  ...
  },
  {
    ...
    duration: "5N/6D",
    destination: "Dubai",
    imageUrl: "https://images.unsplash.com/photo-1708361089093-beef4c4584e7?w=400&q=80",
  },
  {
    name: "Sikkim Circuit",
    duration: "6N/7D",
    destination: "Sikkim",
    imageUrl: "https://images.unsplash.com/photo-1622308644420-b20142dc993c?w=400&q=80",
  },
  {
    ...
    <section className="py-16 bg-brand-varden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex items-end justify-between">
          {/* Heading */}
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-brand-evergreen dark:text-[#faf8f3] font-serif">
              Trending Packages
            </h2>
