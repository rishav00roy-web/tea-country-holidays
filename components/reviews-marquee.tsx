  ...
  return (
    <div className="shrink-0 w-[300px] sm:w-[340px] bg-white dark:bg-[#12291f] rounded-2xl shadow-md border border-brand-gold/10 dark:border-brand-gold/25 p-5 mx-3 flex flex-col gap-3 hover:shadow-xl hover:border-brand-gold/30 transition-all duration-300 relative z-10">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-brand-ink/80 dark:text-white/80">{review.date}</span>
          </div>
        </div>
        {/* Google G logo */}
      ...
      <div className="mt-auto">
        <span className="text-xs font-semibold text-[#826207] dark:text-brand-gold bg-brand-varden dark:bg-[#0d1f1a] px-3 py-1 rounded-full">
          📍 {review.tour}
        </span>
      </div>
    </div>
  ...
  return (
    <section className="py-16 bg-brand-evergreen overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <div className="text-right">
            ...
            <p className="text-white/90 text-xs mt-1">Based on Google Reviews</p>
          </div>
      ...
      <div aria-label="Customer reviews" className="marquee-viewport flex overflow-hidden select-none">
        <Marquee pauseOnHover pauseOnClick={true} autoFill speed={40} className="py-2">
